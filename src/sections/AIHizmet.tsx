    ...
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 py-20 md:py-28">
        ...
        <div className="text-center mb-16 animate-in">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#F36621]/15 border border-[#F36621]/30 rounded-full mb-6">
        ...
        <div className="animate-in mb-16">
          <div className="bg-[#0A1628] rounded-xl border border-white/10 overflow-hidden shadow-2xl max-w-6xl mx-auto">
            {/* Mockup header bar */}
