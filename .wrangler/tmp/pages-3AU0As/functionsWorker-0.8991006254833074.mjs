// ../.wrangler/tmp/bundle-br3qKl/checked-fetch.js
...
app.post("/renovate", async (c) => {
  ...
  const input = {
    prompt: `${command}. Professional architectural renovation photorealistic render, high quality, natural lighting, detailed interior design`,
    num_outputs: 1,
    aspect_ratio: "1:1",
    output_format: "png",
    output_quality: 80
...
// ../.wrangler/tmp/pages-3AU0As/functionsRoutes-0.2530375840076142.mjs
var routes = [
  {
    routePath: "/api/:route*",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-br3qKl/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-br3qKl/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8991006254833074.mjs.map
